...
def get_majors_in_program_category(<category>, <program>)
	limit = flask.request.args.get('limit')
...
def get_majors_by_minimumSalary_in_category(<category>, <minimum_salary>)
	limit = flask.request.args.get('limit')	
...
def get_majors_by_minimum_salary_in_program_in_category(<category>,<program>,<minimum_salary>)
	limit = flask.request.args.get('limit')
