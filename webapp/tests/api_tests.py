...
class career_salary_data_sourceTest(unittest.TestCase):
    ...
    def test_specific_category(self):
        ...
        majors_in_law_and_public_policy = [{"major": "court reporting", "total": 1148, "men": 877, "women": 271,
        ...
        {"major": "Public Policy", "total": 5978, "men": 2639, "women": 3339,
        ...
        {"major": "Pre-law and Legal Studies", "total": 13528, "men": 4435, "women": 9093,
        ...
        {"major": "Public Administration", "total": 5629, "men": 2947, "women": 2682,
        ...
        {"major": "Criminal Justice and Fire Protection", "total": 152824, "men": 80231, "women": 72593,
    ...
    def test_specific_majors_from_any_category(self):
        ...
        chem_majors = [{"major": "Chemical Engineering", "total": 32260, "men": 21239, "women": 11021,
        ...
        {"major": "Chemistry", "total": 66530, "men": 32923, "women": 33607,
        ...
        {"major": "Biochemical Sciences", "total": 39107, "men": 18951, "women": 20156,
    ...
    def test_specific_category_specific_major(self):
        ...
        math_majors_in_cs_and_math =  [{"major": "Mathematics", "total": 72397, "men": 39956, "women": 32441,
        ...
        {"major": "Applied Mathematics", "total": 4939, "men": 2794, "women": 2145,
        ...
        {"major": "Mathematics and Computer Science", "total": 609, "men": 500, "women": 109,
    ...
    def test_all_majors_above_min_salary(self):
        ...
        majors_with_salary_above_70k = [{"major": "Petroleum Engineering", "total": 2339, "men": 2057, "women": 282,
        ...
        {"major": "Mining And Mineral Engineering", "total": 756, "men": 679, "women": 77,
        ...
        {"major": "Metallurgical Engineering", "total": 856, "men": 725, "women": 131,
        ...
        {"major": "Naval Architecture And Marine Engineering", "total": 1258, "men": 1123, "women": 135,
    ...
    def test_all_majors_above_min_salary_float(self):
        majors_with_salary_above_10950_point_35 = [{"major": "Petroleum Engineering", "total": 2339, "men": 2057, "women": 282,
        "category": 'Engineering', "employed": 1976, "full_time": 1849, "part_time": 270,
        "unemployed": 37, "unemployment_rate": 0.018380527, "median": 110000, "p25th": 95000, "p75th": 125000,
        "college_jobs": 1534, "non_college_jobs": 364, "low_wage_jobs": 193}]
    ...
    def test_all_majors_from_specific_category_with_min_salary(self):
        ...
        majors_in_arts_with_salary_above_45k = [{"major": "Miscellaneous fine arts", "total": 3340, "men": 1970, "women": 1370,
    ...
    def test_specific_majors_from_any_category_with_min_salary(self):
        ...
        physics_majors_with_salary_above_55k = [{"major": "Astronomy And Astrophysics", "total": 1792, "men": 832, "women": 960,
        ...
        {"major": "Engineering Mechanics Physics And Science", "total": 4321, "men": 3526, "women": 795,
    ...
    def test_specific_majors_from_specific_category_above_min_salary(self):
        ...
        medical_majors_in_health_with_salary_above_40k = [{"major": "Medical Technologies Technicians", "total": 15914, "men": 3916, "women": 11998,
        ...
        {"major": "Medical Assisting Services", "total": 11123, "men": 803, "women": 10320,
    ...
    def test_sort_by_major(self):
        #EXAMPLE: majorinfo.com/majors/?maj=law_and_public_policy/
        majors_in_law_and_public_policy_sort_by_major_alphabetically = [{"major": "Court Reporting", "total": 1148, "men": 877, "women": 271,
        "category": 'Law & Public Policy', "employed": 930, "full_time": 808, "part_time": 223,
        "unemployed": 11, "unemployment_rate": 0.011689692, "median": 54000, "p25th": 50000, "p75th": 54000,
        "college_jobs": 402, "non_college_jobs": 528, "low_wage_jobs": 144},
        {"major": "Criminal Justice and Fire Protection", "total": 152824, "men": 80231, "women": 72593,
    ...
    def test_sort_by_category_id(self):
        ...
        "unemployed": 2249, "unemployment_rate": 0.080531385, "median": 37400, "p25th": 29000, "p75th": 50000,
        "college_jobs": 15654, "non_college_jobs": 8394, "low_wage_jobs": 3012}]
        self.assertEquals(self.career_salary_data_source.get_majors(major_contains = "science", sort_by = 'low_wage_jobs'), majors_containing_science)

    def test_sort_by_total(self):
        #EXAMPLE: majorinfo.com/majors/?maj=law_and_public_policy&sort_by=total/
        majors_in_law_and_public_policy_sort_by_total = [{"major": "Criminal Justice and Fire Protection", "total": 152824, "men": 80231, "women": 72593,
        "category": 'Law & Public Policy', "employed": 125393, "full_time": 109970, "part_time": 32242,
        "unemployed": 11268, "unemployment_rate": 0.082452199, "median": 35000, "p25th": 26000, "p75th": 45000,
        "college_jobs": 24348, "non_college_jobs": 88858, "low_wage_jobs": 18404},
        {"major": "Pre-law and Legal Studies", "total": 13528, "men": 4435, "women": 9093,
        ...
        "unemployed": 789, "unemployment_rate": 0.1594906, "median": 36000, "p25th": 23000, "p75th": 60000,
        "college_jobs": 912, "non_college_jobs": 2313, "low_wage_jobs": 496},
        {"major": "court reporting", "total": 1148, "men": 877, "women": 271,
        "category": 'Law & Public Policy', "employed": 930, "full_time": 808, "part_time": 223,
        "unemployed": 11, "unemployment_rate": 0.011689692, "median": 54000, "p25th": 50000, "p75th": 54000,
        "college_jobs": 402, "non_college_jobs": 528, "low_wage_jobs": 144}]
    ...
    def test_sort_by_percent_non_college_jobs(self):
        majors_in_law_and_public_policy_sort_by_percent_non_college_jobs = [
        # 88858/(24348+88858+18404) = 0.6751614618949928
        {"major": "Criminal Justice and Fire Protection", "total": 152824, "men": 80231, "women": 72593,
        "category": 'Law & Public Policy', "employed": 125393, "full_time": 109970, "part_time": 32242,
        "unemployed": 11268, "unemployment_rate": 0.082452199, "median": 35000, "p25th": 26000, "p75th": 45000,
        "college_jobs": 24348, "non_college_jobs": 88858, "low_wage_jobs": 18404}
        # 6454/(2002+6454+1336) = 0.659109477124183
        {"major": "Pre-law and Legal Studies", "total": 13528, "men": 4435, "women": 9093,
        "category": 'Law & Public Policy', "employed": 9762, "full_time": 7851, "part_time": 3595,
        "unemployed": 757, "unemployment_rate": 0.071965016, "median": 36000, "p25th": 29200, "p75th": 46000,
        "college_jobs": 2002, "non_college_jobs": 6454, "low_wage_jobs": 1336},
        # 2313/(912+2313+496) = 0.6216070948669713
        {"major": "Public Administration", "total": 5629, "men": 2947, "women": 2682,
        "category": 'Law & Public Policy', "employed": 4158, "full_time": 4148, "part_time": 847,
        "unemployed": 789, "unemployment_rate": 0.1594906, "median": 36000, "p25th": 23000, "p75th": 60000,
        "college_jobs": 912, "non_college_jobs": 2313, "low_wage_jobs": 496},
        # 528/(402+528+144) = 0.49162011173184356
        {"major": "court reporting", "total": 1148, "men": 877, "women": 271,
        "category": 'Law & Public Policy', "employed": 930, "full_time": 808, "part_time": 223,
        "unemployed": 11, "unemployment_rate": 0.011689692, "median": 54000, "p25th": 50000, "p75th": 54000,
        "college_jobs": 402, "non_college_jobs": 528, "low_wage_jobs": 144},
        # 1871/(1550+1871+340) = 0.49747407604360544
        {"major": "Public Policy", "total": 5978, "men": 2639, "women": 3339,
        "category": 'Law & Public Policy', "employed": 4547, "full_time": 4163, "part_time":
        1306, "unemployed": 670, "unemployment_rate": 0.128426299, "median": 50000, "p25th": 35000, "p75th": 70000,
        "college_jobs": 1550, "non_college_jobs": 1871, "low_wage_jobs": 340}]
        self.assertEquals(self.career_salary_data_source.get_majors(category_id = 3, sort_by = 'non_college_jobs'), majors_in_law_and_public_policy_sort_by_percent_non_college_jobs)

    def test_sort_by_low_wage_jobs(self):
        majors_in_law_and_public_policy_sort_by_low_wage_jobs = [
        # 18404/(24348+88858+18404) = 0.13983739837398373
        {"major": "Criminal Justice and Fire Protection", "total": 152824, "men": 80231, "women": 72593,
        "category": 'Law & Public Policy', "employed": 125393, "full_time": 109970, "part_time": 32242,
        "unemployed": 11268, "unemployment_rate": 0.082452199, "median": 35000, "p25th": 26000, "p75th": 45000,
        "college_jobs": 24348, "non_college_jobs": 88858, "low_wage_jobs": 18404}
        # 1336/(2002+6454+1336) = 0.136437908496732
        {"major": "Pre-law and Legal Studies", "total": 13528, "men": 4435, "women": 9093,
        "category": 'Law & Public Policy', "employed": 9762, "full_time": 7851, "part_time": 3595,
        "unemployed": 757, "unemployment_rate": 0.071965016, "median": 36000, "p25th": 29200, "p75th": 46000,
        "college_jobs": 2002, "non_college_jobs": 6454, "low_wage_jobs": 1336},
        # 144/(402+528+144) = 0.1340782122905028
        {"major": "court reporting", "total": 1148, "men": 877, "women": 271,
        "category": 'Law & Public Policy', "employed": 930, "full_time": 808, "part_time": 223,
        "unemployed": 11, "unemployment_rate": 0.011689692, "median": 54000, "p25th": 50000, "p75th": 54000,
        "college_jobs": 402, "non_college_jobs": 528, "low_wage_jobs": 144},
        # 496/(912+2313+496) = 0.1332975006718624
        {"major": "Public Administration", "total": 5629, "men": 2947, "women": 2682,
        "category": 'Law & Public Policy', "employed": 4158, "full_time": 4148, "part_time": 847,
        "unemployed": 789, "unemployment_rate": 0.1594906, "median": 36000, "p25th": 23000, "p75th": 60000,
        "college_jobs": 912, "non_college_jobs": 2313, "low_wage_jobs": 496},
        # 340/(1550+1871+340) = 0.0904014889657006
        {"major": "Public Policy", "total": 5978, "men": 2639, "women": 3339,
        "category": 'Law & Public Policy', "employed": 4547, "full_time": 4163, "part_time":
        1306, "unemployed": 670, "unemployment_rate": 0.128426299, "median": 50000, "p25th": 35000, "p75th": 70000,
        "college_jobs": 1550, "non_college_jobs": 1871, "low_wage_jobs": 340}]
        self.assertEquals(self.career_salary_data_source.get_majors(category_id = 3, sort_by = 'low_wage_jobs'), majors_in_law_and_public_policy_sort_by_low_wage_jobs)
