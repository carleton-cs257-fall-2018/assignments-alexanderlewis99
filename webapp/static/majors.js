...
function toggleAdvancedOptions() {
    ...
    if(!advanced_options_visible){
      ...
      advanced_options_form_html += advanced_options_form_html += "<input type='checkbox' value='category' checked><label for='category'>Category</label>";
      ...
      advanced_options_form_html += "<input type='checkbox' value='percent_men'><label for='percent_men'>Percent Male</label>";
      advanced_options_form_html += "<input type='checkbox' value='percent_women'><label for='percent_women'>Percent Female</label>";
